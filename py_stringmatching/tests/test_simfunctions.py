...
class RatioTestCases(unittest.TestCase):
    ...
    def test_valid_input_raw_score(self):
        ...
        self.assertEqual(self.ratio.get_raw_score('sturgeon', 'urgently'), 63)
    ...
    def test_valid_input_sim_score(self):
        self.assertEqual(self.ratio.get_sim_score('a', ''), 0.0)
        self.assertEqual(self.ratio.get_sim_score('', 'a'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('abc', ''), 0.0)
        self.assertEqual(self.ratio.get_sim_score('', 'abc'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('', ''), 0.0)
        self.assertEqual(self.ratio.get_sim_score('a', 'a'), 1.0)
        self.assertEqual(self.ratio.get_sim_score('abc', 'abc'), 1.0)
        self.assertEqual(self.ratio.get_sim_score('a', 'ab'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('b', 'ab'), 0.67)
        self.assertEqual(self.ratio.get_sim_score(' ac', 'abc'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('abcdefg', 'xabxcdxxefxgx'), 0.70)
        self.assertEqual(self.ratio.get_sim_score('ab', 'a'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('ab', 'A'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('Ab', 'a'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('Ab', 'A'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('Ab', 'b'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('ab', 'b'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('abc', 'ac'), 0.80)
        self.assertEqual(self.ratio.get_sim_score('xabxcdxxefxgx', 'abcdefg'), 0.70)
        self.assertEqual(self.ratio.get_sim_score('a', 'b'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('ab', 'ac'), 0.50)
        self.assertEqual(self.ratio.get_sim_score('ac', 'bc'), 0.50)
        self.assertEqual(self.ratio.get_sim_score('abc', 'axc'), 0.67)
        self.assertEqual(self.ratio.get_sim_score('xabxcdxxefxgx', '1ab2cd34ef5g6'), 0.54)
        self.assertEqual(self.ratio.get_sim_score('example', 'samples'), 0.71)
        self.assertEqual(self.ratio.get_sim_score('sturgeon', 'urgently'), 0.63)
        self.assertEqual(self.ratio.get_sim_score('bag_distance', 'frankenstein'), 0.33)
        self.assertEqual(self.ratio.get_sim_score('distance', 'difference'), 0.56)
        self.assertEqual(self.ratio.get_sim_score('java was neat', 'scala is great'), 0.59)
        self.assertEqual(self.ratio.get_sim_score('java wAs nEat', 'scala is great'), 0.52)
        self.assertEqual(self.ratio.get_sim_score('scaLA is greAT', 'java wAs nEat'), 0.30)
