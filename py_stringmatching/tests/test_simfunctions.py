...
class PartialRatioTestCases(unittest.TestCase):
    ...
    def test_valid_input_sim_score(self):
        ...
        self.assertEqual(self.ratio.get_sim_score('a', 'ab'), 1.0)
        self.assertEqual(self.ratio.get_sim_score('b', 'ab'), 1.0)
        ...
        self.assertEqual(self.ratio.get_sim_score('ab', 'a'), 1.0)
        self.assertEqual(self.ratio.get_sim_score('ab', 'A'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('Ab', 'a'), 0.0)
        self.assertEqual(self.ratio.get_sim_score('Ab', 'A'), 1.0)
        self.assertEqual(self.ratio.get_sim_score('Ab', 'b'), 1.0)
        self.assertEqual(self.ratio.get_sim_score('ab', 'b'), 1.0)
        ...
        self.assertAlmostEqual(self.ratio.get_sim_score('sturgeon', 'urgently'), 0.63)
